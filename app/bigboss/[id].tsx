...
import { ActivityIndicator, FlatList, RefreshControl, StyleSheet, Text, TouchableOpacity, View, Modal, TextInput, Alert, ScrollView } from 'react-native';
...
export default function BigBossDetailScreen() {
    ...
    const handleDeleteBigBoss = async () => {
        Alert.alert(
            'Delete Big Boss',
            'Are you sure you want to delete this Big Boss and all its bills?',
            [
                { text: 'Cancel', style: 'cancel' },
                {
                    text: 'Delete',
                    ...
                    onPress: async () => {
                        try {
                            ...
                            if (success) {
                                Alert.alert('Success', 'Big Boss deleted successfully');
                                router.back();
                            } else {
                                Alert.alert('Error', 'Failed to delete Big Boss');
                            }
                        } catch (err) {
                            Alert.alert('Error', 'Failed to delete Big Boss');
    ...
    const handleUpdateBigBoss = async () => {
        ...
        try {
            ...
            if (result) {
                ...
                fetchData();
                Alert.alert('Success', 'Big Boss updated successfully');
            } else {
                Alert.alert('Error', 'Failed to update Big Boss');
            }
        } catch (err) {
            Alert.alert('Error', 'Failed to update Big Boss');
