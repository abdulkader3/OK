...
import { ActivityIndicator, FlatList, RefreshControl, StyleSheet, Text, TouchableOpacity, View, Modal, TextInput, Alert } from 'react-native';
    ...
    const handleCreateBigBoss = async () => {
        ...
        try {
            ...
            if (result) {
                ...
                Alert.alert('Error', 'Failed to create Big Boss');
            }
        } catch (err) {
            Alert.alert('Error', 'Failed to create Big Boss');
