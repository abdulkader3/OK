...
import { ActivityIndicator, Image, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, View, Linking } from 'react-native';
                ...
                >
                    ...
                    {payment.attachment && (
                        <View style={styles.section}>
                            ...
                            >
                                <Image 
                                    source={{ uri: payment.attachment.url }} 
